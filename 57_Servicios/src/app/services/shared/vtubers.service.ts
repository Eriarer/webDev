...
export class VtubersService {
  private vtubers: vtubers[] = [
    ...
    },
    {
      ...
      bio: "Una ídolo cuyo sueño es convertirse en la dueña de una cadena de comida rápida. Kiara es un fénix, no un pollo o un pavo. (Muy importante) Ella brilla intensamente, trabajando hasta el cansancio ya que simplemente renacerá de sus cenizas de todos modos.",
    ...
    {
      nombre: "Gawr Gura",
      bio: "Una descendiente de la Ciudad Perdida de Atlantis, que nadó a la Tierra mientras decía: '¡Es tan aburrido allá abajo, jajaja!' Gura compró su ropa (y su sombrero de tiburón) en el mundo humano y realmente los ama. En su tiempo libre, disfruta hablando con la vida marina.",
